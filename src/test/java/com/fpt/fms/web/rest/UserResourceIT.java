...
class UserResourceIT {
    ...
    public static User createEntity(EntityManager em) {
        User user = new User();
        user.setEmail(DEFAULT_LOGIN + RandomStringUtils.randomAlphabetic(5));
    ...
    void createUser() throws Exception {
        ...
        managedUserVM.setEmail(DEFAULT_LOGIN);
        ...
        assertPersistedUsers(
            users -> {
                ...
                assertThat(testUser.getEmail()).isEqualTo(DEFAULT_LOGIN);
    ...
    void createUserWithExistingLogin() throws Exception {
        ...
        ManagedUserVM managedUserVM = new ManagedUserVM();
        managedUserVM.setEmail(DEFAULT_LOGIN); // this login should already be used
        managedUserVM.setPassword(DEFAULT_PASSWORD);
        managedUserVM.setFirstName(DEFAULT_FIRSTNAME);
        managedUserVM.setLastName(DEFAULT_LASTNAME);
//        managedUserVM.setEmail("anothermail@localhost");
    ...
    void createUserWithExistingEmail() throws Exception {
        ...
        ManagedUserVM managedUserVM = new ManagedUserVM();
        managedUserVM.setEmail("anotherlogin");
        managedUserVM.setPassword(DEFAULT_PASSWORD);
        managedUserVM.setFirstName(DEFAULT_FIRSTNAME);
        managedUserVM.setLastName(DEFAULT_LASTNAME);
//        managedUserVM.setEmail(DEFAULT_EMAIL); // this email should already be used
    ...
    void updateUserLogin() throws Exception {
        ...
        ManagedUserVM managedUserVM = new ManagedUserVM();
        managedUserVM.setId(updatedUser.getId());
        managedUserVM.setEmail(UPDATED_LOGIN);
        managedUserVM.setPassword(UPDATED_PASSWORD);
        managedUserVM.setFirstName(UPDATED_FIRSTNAME);
        managedUserVM.setLastName(UPDATED_LASTNAME);
        managedUserVM.setEmail(UPDATED_EMAIL);
        ...
        assertPersistedUsers(
            users -> {
                assertThat(users).hasSize(databaseSizeBeforeUpdate);
                User testUser = users.stream().filter(usr -> usr.getId().equals(updatedUser.getId())).findFirst().get();
                assertThat(testUser.getEmail()).isEqualTo(UPDATED_LOGIN);
                assertThat(testUser.getFirstName()).isEqualTo(UPDATED_FIRSTNAME);
                assertThat(testUser.getLastName()).isEqualTo(UPDATED_LASTNAME);
                assertThat(testUser.getEmail()).isEqualTo(UPDATED_EMAIL);
                assertThat(testUser.getImageUrl()).isEqualTo(UPDATED_IMAGEURL);
    ...
    void updateUserExistingLogin() throws Exception {
        ...
        ManagedUserVM managedUserVM = new ManagedUserVM();
        managedUserVM.setId(updatedUser.getId());
        managedUserVM.setEmail("jhipster"); // this login should already be used by anotherUser
        managedUserVM.setPassword(updatedUser.getPassword());
        managedUserVM.setFirstName(updatedUser.getFirstName());
        managedUserVM.setLastName(updatedUser.getLastName());
        managedUserVM.setEmail(updatedUser.getEmail());
    ...
    void testUserDTOtoUser() {
        ...
        userDTO.setEmail(DEFAULT_LOGIN);
        ...
        assertThat(user.getEmail()).isEqualTo(DEFAULT_LOGIN);
    ...
    void testUserToUserDTO() {
        ...
        assertThat(userDTO.getEmail()).isEqualTo(DEFAULT_LOGIN);
