...
public final class UtUtils {
    ...
    public static void setField(Object object, String fieldClassName, String fieldName, Object fieldValue) throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException, IllegalAccessException, java.lang.reflect.InvocationTargetException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields97771526723500 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields97771526723500.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass97771526751100 = (java.lang.reflect.Field[]) methodForGetDeclaredFields97771526723500.invoke(java.lang.reflect.Field.class, false);
        modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass97771526751100).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static void setStaticField(Class<?> clazz, String fieldName, Object fieldValue) throws NoSuchFieldException, IllegalAccessException {
        ...
        try {
            ...
            java.lang.reflect.Method methodForGetDeclaredFields97771527465800 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
            methodForGetDeclaredFields97771527465800.setAccessible(true);
            java.lang.reflect.Field[] allFieldsFromFieldClass97771527466700 = (java.lang.reflect.Field[]) methodForGetDeclaredFields97771527465800.invoke(java.lang.reflect.Field.class, false);
            modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass97771527466700).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static Object getFieldValue(Object obj, String fieldClassName, String fieldName) throws ClassNotFoundException, NoSuchMethodException, java.lang.reflect.InvocationTargetException, IllegalAccessException, NoSuchFieldException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields97771528577400 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields97771528577400.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass97771528578400 = (java.lang.reflect.Field[]) methodForGetDeclaredFields97771528577400.invoke(java.lang.reflect.Field.class, false);
        modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass97771528578400).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static Object getStaticFieldValue(Class<?> clazz, String fieldName) throws IllegalAccessException, NoSuchFieldException {
        ...
        do {
            try {
                ...
                java.lang.reflect.Method methodForGetDeclaredFields97771529232800 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
                methodForGetDeclaredFields97771529232800.setAccessible(true);
                java.lang.reflect.Field[] allFieldsFromFieldClass97771529233600 = (java.lang.reflect.Field[]) methodForGetDeclaredFields97771529232800.invoke(java.lang.reflect.Field.class, false);
                modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass97771529233600).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    private static java.lang.invoke.MethodHandles.Lookup getLookupIn(Class<?> clazz) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, java.lang.reflect.InvocationTargetException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields97771538187200 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields97771538187200.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass97771538191500 = (java.lang.reflect.Field[]) methodForGetDeclaredFields97771538187200.invoke(java.lang.invoke.MethodHandles.Lookup.class, false);
        allowedModes = java.util.Arrays.stream(allFieldsFromFieldClass97771538191500).filter(field1 -> field1.getName().equals("allowedModes")).findFirst().get();


        java.lang.reflect.Method methodForGetDeclaredFields97771538196600 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields97771538196600.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass97771538196800 = (java.lang.reflect.Field[]) methodForGetDeclaredFields97771538196600.invoke(java.lang.invoke.MethodHandles.Lookup.class, false);
        allModesField = java.util.Arrays.stream(allFieldsFromFieldClass97771538196800).filter(field1 -> field1.getName().equals("ALL_MODES")).findFirst().get();
